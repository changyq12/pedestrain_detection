...
opts.per_nms_topN           = -1;
opts.nms_overlap_thres      = -1;
opts.after_nms_topN         = -1;
opts.use_gpu                = true;
...
opts.test_min_box_size      = 1;
opts.test_min_box_height    = 1;
...
im_names = {'set06.jpg', 'set07.jpg', 'set08.jpg','set09.jpg','set10.jpg'};
