function save_model_path = proposal_train_caltech(conf, imdb_train, roidb_train, varargin)
...
%% making tran/val data
    ...
    if opts.do_val
        ...
        % fix validation data
        shuffled_inds_val   = generate_random_minibatch([], image_roidb_val, conf.ims_per_batch, opts.fg_image_ratio);
