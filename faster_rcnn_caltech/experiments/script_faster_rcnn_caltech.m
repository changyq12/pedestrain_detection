...
cache_base_proposal         = 'faster_rcnn_caltech_vgg_16layers';
...
cache_name='caltech_faster_rcnn_stage1'
method_name='faster-rcnn-stage1'
% test
opts.mAP                    = Faster_RCNN_Train.do_fast_rcnn_test_caltech(conf_fast_rcnn, model.stage1_fast_rcnn, dataset.imdb_test, dataset.roidb_test);
%conf_fast_rcnn.exp_name='faster-rcnn-caltech';
%Faster_RCNN_Train.do_proposal_test_caltech(conf_fast_rcnn,model.stage1_fast_rcnn,dataset.imdb_test,dataset.roidb_test,cache_name,method_name);
%%  stage two proposal
% net proposal
fprintf('\n***************\nstage two proposal\n***************\n');
% train
...
dataset.roidb_test       	= Faster_RCNN_Train.do_proposal_test(conf_proposal, model.stage2_rpn, dataset.imdb_test, dataset.roidb_test);
opts.final_mAP              = Faster_RCNN_Train.do_fast_rcnn_test_caltech(conf_fast_rcnn, model.stage2_fast_rcnn, dataset.imdb_test, dataset.roidb_test);

%cache_name = 'caltech';
%method_name = 'faster-rcnn';
%Faster_RCNN_Train.do_proposal_test_caltech(conf_fast_rcnn, model.stage2_fast_rcnn, dataset.imdb_test, dataset.roidb_test, cache_name, method_name);
